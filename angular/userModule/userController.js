	...
	$scope.data = [
	    {
	        ...
	        "created":     	"2011/06/25",        
	        "more": 		'<div class="dropdown"><button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">more <span class="caret"></span></button><ul class="dropdown-menu" aria-labelledby="dropdownMenu1"><li><a href="#">Add a Domains</a></li><li><a href="#">Access Console</a></li><li><a href="#">Resize Droplet</a></li><li><a href="#">View Usage</a></li><li><a href="#">Enamle Backups</a></li></ul></div>',
	    },
	    {
	        "name":       	"Nixon",
	        "address":   	"139.59.152.135",
